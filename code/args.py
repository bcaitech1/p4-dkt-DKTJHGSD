...
#                       default=[['duration'], ['difficulty_mean', 'difficulty_sum'], ['assId_mean', 'assId_sum'], ['tag_mean', 'tag_sum'], ['testId_mean', 'testId_sum']],
                        ...
                        #            default=[['duration'], ['difficulty_mean', 'difficulty_std', 'difficulty_sum'], ['assId_mean', 'assId_std', 'assId_sum'], ['tag_mean', 'tag_std', 'tag_sum'], ['testId_mean', 'testId_std', 'testId_sum']],

...
def parse_args():
    ...
    parser.add_argument('--weight_decay',default=1e-5,type=float,help='weight decay') #changhyeong
    ...
    ## 중요 ##
    parser.add_argument('--model', default='convbert', type=str, help='model type')

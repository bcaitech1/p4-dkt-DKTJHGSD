...
def parse_args():
    ...
    parser.add_argument('--testid_cnt', default=3, type=int, help='minimum testid_cnt, 0 choose by length') # 3

    # feature
    parser.add_argument('--continuous_feats', type=list, nargs='+', 
            default=[['duration'], ['lag_time'], ['difficulty_mean', 'difficulty_std'], \
                    ['assId_mean'], ['testId_mean', 'testId_std'], ['tag_mean', 'tag_std']], 
            help = 'duration, tag_solved, tag_avg, testid_solved, testid_avg, difficulty_mean,\
                    difficulty_std, assId_mean, assId_std, tag_mean, tag_std, testId_mean, \
                    testId_std, acc_tag_solved, acc_tag_avg, acc_testid_solved, acc_testid_avg, \
